...
- **Complete**: Finished task (maintains history) and is still visible
...
- Enable filtering and grouping of todos (important thing to note - think of performance with ability to do groupby on tags)
